...
/**
 *  JIVER Channel Class - This class includes Channel ID, Number of members within the channel, Channel URL, Channel Topic, Cover image URL, Channel creation timestamp
 */
