...
/**
 *  Class used for Messaging/Group messaging channel. This class includes [`JiverChannel`](./JiverChannel.html) object. This contains information such as: users within the channel, timestamp of each users' most recent read receipts, unread message counts for the current user, last message within the channel, new messages created after the current user joined the channel, channel type (1-on-1 or group), etc.
 */
 ...
 *
 *  @param userId User ID. Same as [`JiverUser guestID`](./JiverUser.html#//api/name/guestId)
 *
