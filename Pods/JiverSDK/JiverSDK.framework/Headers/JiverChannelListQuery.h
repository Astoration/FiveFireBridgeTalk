...
/**
 *  Class used for retrieving the Channel List from Open Chat. The class includes current page, next page, and number of channels per page used for Pagination. Can be used to retrieve search results based on keywords. Call [`nextWithResultBlock:endBlock:`](./JiverChannelListQuery.html#//api/name/nextWithResultBlock:endBlock:) after setting [`limit`](./JiverChannelListQuery.html#//api/name/limit) and [`query`](./JiverChannelListQuery.html#//api/name/query).
 */
...
/**
 *  Get the list of channels. If this method is repeatedly called, it will retrieve the following pages of the channel list. The retrieved list will be returned within onResult as queryResult, which contains of an array of [`JiverChannel`](./JiverChannel.html).
 *
